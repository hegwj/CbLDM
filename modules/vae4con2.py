...
class Encoder(nn.Module):
    def __init__(self, input_channel=6, ch=16, latent_channel=8, n_layer=2):
        super().__init__()
    ...
    def net(self):
        ...
        for i in range(self.n_layer):
            ...
            layers[f'ebn_{i}'] = nn.BatchNorm1d(self.ch * 4 ** (i + 1))
    ...
    def net(self):
        ...
        for i in range(self.n_layer):
            if i <= self.n_layer - 1:
                ...
                layers[f'dconv_{i}'] = nn.Conv1d(in_channels=self.ch * 4,
