...
from utils.attn import SpatialTransformer
...
def normalization(in_channels, num_groups=8):
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, context=None, timestep=None):
        hs = []
        t_emb = timestep_embedding(timestep, self.model_channels)
